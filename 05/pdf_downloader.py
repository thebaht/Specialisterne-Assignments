...
root.geometry("200x600")                # Set window dimensions
...
scrollable_frame = tk.Frame(canvas, bg='gray6')
...
for i, row in df.head(20).iterrows():
# for i, row in df.iterrows():
    label = tk.Label(scrollable_frame, text=f"{i}", padx=5, image=arrow_icon, compound='right', font=global_font, fg='gray90', bg='gray6')
